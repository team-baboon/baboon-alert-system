...
<form class="form-login">
  ...
  <button class="btn btn-lg btn-outline-primary btn-block" type="submit" onclick="return verifyCredentials()">Create User
  </button>
...
<script>
  function verifyCredentials() {
    ...
    if (username === "admin" && password === "hunter2" && password2 === password) {
